...
public class InversionSimulacionBean {
    ...
    public InversionSimulacionBean(DistribuidorMarkFuture distribuidor) {
    ...
    public String procesarSimulacion() {
        List<PryVeh> proyectos = modificarProyectos();
        getDistribuidor().getDistribuidorGeneralProyectos().setProyectos(proyectos);
    ...
    private List<PryVeh> modificarProyectos() {
            List<PryVeh> proyectos = distribuidor.getDistribuidorGeneralProyectos().getProyectos();
