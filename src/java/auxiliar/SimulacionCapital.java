...
public class SimulacionCapital {
    ...
    public SimulacionCapital(DistribuidorMarkFuture distribuidorModeloVehiculo){
        valorGeneralModificado=false;
        this.distribuidor=distribuidorModeloVehiculo;
        llenarBeanSimulacionCapital();
        vela=new CandleBean(getDistribuidor());
    ...
    private void llenarBeanSimulacionCapital() {
        getDistribuidor().llenarBeanSimulacionCapital(this);
    }
    ...
    public DistribuidorMarkFuture preSimulacion(){
        ...
        getDistribuidor().modificarSimulacionCapital(this);
