...
public class SimulacionMinistracion {
    ...
    public SimulacionMinistracion(DistribuidorMarkFuture distribuidor) {
    ...
    public DistribuidorMarkFuture preSimulacion() {
        distribuidor.getDistribuidorGeneralProyectos().setTiempoMinistracion(getMesesMinistracion());
            distribuidor.getDistribuidorGeneralProyectos().setTiempoPago(getMesesPago());
            distribuidor.getDistribuidorGeneralProyectos().modelarPrincipal();
            return distribuidor;
    }
    ...
    public String simularMinistracion() {
        ...
        if (getMesesMinistracion() + getMesesPago() > 60) {
            ...
            distribuidor.getDistribuidorGeneralProyectos().setTiempoPago(getMesesPago());
            distribuidor.getDistribuidorGeneralProyectos().modelarPrincipal();
            distribuidor.getDistribuidorGeneralProyectos().llenarBeanGrafica(this);
            distribuidor.getDistribuidorGeneralProyectos().setTiempoMinistracion(18);
            distribuidor.getDistribuidorGeneralProyectos().setTiempoPago(12);
