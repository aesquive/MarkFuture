...
public class Dao {
  ...
  public TipMapCalVeh getTip_map(int tipo_num) {
    ...
    public Usu getUsu(int parseInt) {
        return (Usu) sesion.createCriteria(Usu.class).add(Restrictions.eq("id", parseInt)).list().get(0);
    }

    public DatVeh getDatVeh(Integer id) {
        return (DatVeh) sesion.createCriteria(DatVeh.class).add(Restrictions.eq("id", id)).list().get(0);
    }

    public EtpVeh getEtpVeh(Integer id) {
        return (EtpVeh) sesion.createCriteria(EtpVeh.class).add(Restrictions.eq("id", id)).list().get(0);
    }
