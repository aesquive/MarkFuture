...
public class GuardadorModelo {
    ...
    public GuardadorModelo(MdlVeh modeloOriginal, DistribuidorModeloVehiculo distribuidor) {
    ...
    private void guardarMdlVeh() {
        ...
        modeloNuevo.setNomMdl(modeloOriginal.getNomMdl()  + Funciones.DateToString(Calendar.getInstance().getTime()));
